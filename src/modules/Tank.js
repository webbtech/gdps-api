...
export const resolvers = {
  Mutation: {
    createTank: (_, { input }, { docClient }) => createTank(input, docClient),
    updateTank: (_, { input }, { docClient }) => updateTank(input, docClient),
    updateTankLevels: (_, { input }, { docClient }) => updateTankLevels(input, docClient),
  },
  Query: {
    tank: (_, { id }, { db }) => fetchTank(id, db),
